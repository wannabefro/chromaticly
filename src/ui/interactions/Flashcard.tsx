...
const styles = StyleSheet.create({
  ...
  categoryRow: { flexDirection: 'row', alignItems: 'center', gap: shape.spaceSnug },
  ...
  revealedBody: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: shape.spaceInline },
  ...
  previewPlay: { flexDirection: 'row', alignItems: 'center', gap: shape.spaceSnug },
  ...
  gradeRow: { flexDirection: 'row', gap: shape.spaceSnug },
  gradeButton: {
    flex: 1,
    minHeight: 56,
